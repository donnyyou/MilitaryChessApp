                    ...
                    while (true) {
                        ...
                        if (fuwuSocket.isConnected()) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(BlueToothMatchActivity.this, "接收挑战请求，建立连接成功！", Toast.LENGTH_SHORT);
                                    //执行socket方法
                            ...
                            //跳转到蓝牙游戏activity
                            Intent i = new Intent(BlueToothMatchActivity.this, BlueToothGameAty.class);
                            startActivity(i);
                            //初始化线程来传输数据
    ...
    private void buildConnect(int position, boolean isfaqiren) {
        ...
        try {
            ...
            //如果已经配对好了
                ...
                final AlertDialog aDialog = new AlertDialog.Builder(BlueToothMatchActivity.this).
                        setTitle("发起对战").
                                        ...
                                        try {
                                            ...
                                            if (kehuduanSocket.isConnected()) {
                                                runOnUiThread(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        Toast.makeText(BlueToothMatchActivity.this, "连接成功！！", Toast.LENGTH_SHORT).show();
                                                        //执行socket方法
                                                        BlueToothGameAty blueToothGameAty = new BlueToothGameAty();
                                            ...
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Toast.makeText(BlueToothMatchActivity.this, "连接失败！！" + e.getMessage(), Toast.LENGTH_SHORT).show();
